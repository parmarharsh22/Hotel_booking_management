...
detailsBtn.forEach(btn=>{
    btn.addEventListener('click',(e)=>{
        ...
        window.location=`/rooms/${hotelId}?location=${serverData.location}&checkIn=${serverData.checkIn}&checkOut=${serverData.checkOut}&hotelName=${hotelName}&rooms=${serverData.rooms}&adults=${serverData.adults}&children=${serverData.children}`   
    })
})